    ...
    <section data-surface-tone={tone} className={`${sectionClass} rhythm-divider ${sectionPadding} text-center`} id="contact">
      <Reveal className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          >
            <span className="relative z-10 font-editorial-caps text-lg tracking-[0.2em] text-[#102b57] transition-colors duration-500 group-hover:text-[#0b1f44]">
              Initialize Project
            </span>
            <span className="material-symbols-outlined relative z-10 text-[1.05rem] text-[#102b57] transition-all duration-500 translate-x-10 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 group-hover:text-[#0b1f44]">
              arrow_forward
            </span>
            <div className="absolute inset-0 -translate-x-6 bg-[linear-gradient(90deg,#8f7bff_0%,#c8b4ff_35%,#ffffff_100%)] opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-0" />
          </AppLink>
          <AppLink
